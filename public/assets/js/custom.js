...
function abrirVentanaPDF(url) {
    ...
    const width = 800; // Ancho de la ventana emergente
    const height = 600; // Alto de la ventana emergente

    // Calcula posición centrada en la pantalla
    ...
    // Enviar a imprimir cuando cargue el contenido
    pdfWindow.onload = function (e) {
        pdfWindow.print();
    };
}

function alertSW(icono, titulo, tiempo = 1500) {
    Swal.fire({
        toast: true,
        position: "top-end",
        icon: icono,
